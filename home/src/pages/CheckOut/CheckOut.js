...
function CheckOut(props) {
              ...
              <Row>
                  <Col>
                        <div className="Checkout__form">
                            <p className="Checkout__form__title">Contact information</p>
                            <input className="Checkout__form__input" placeholder="Email or mobile phone number"/>
                            <p className="Checkout__form__title">Shipping address</p>
  ...
  <option data-code="ZW" value="Zimbabwe">Zimbabwe</option></select>
                            <input className="Checkout__form__input" placeholder="Post code"/>
                        </div>
                  </Col>
                  <Col>
