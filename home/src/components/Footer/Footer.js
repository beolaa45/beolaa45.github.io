...
import { faFacebookF, faTwitter, faYoutube, faPape,faInstagram } from '@fortawesome/free-brands-svg-icons'
import { faMapMarkedAlt, faEnvelope, faPhone, faFace } from '@fortawesome/free-solid-svg-icons'
import "./Footer.scss";
